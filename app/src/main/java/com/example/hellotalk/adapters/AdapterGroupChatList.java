...
import com.example.hellotalk.GroupChatActivity;
...
public class AdapterGroupChatList extends RecyclerView.Adapter<AdapterGroupChatList.HolderGroupChatList> {
    ...
    public void onBindViewHolder(@NonNull HolderGroupChatList holder, int position) {
        ...
        //load last message and message-item
        loadLastMessage(model, holder);

        //set data
        holder.groupTitleTv.setText(groupTitle);
        try{
            Picasso.get().load(groupIcon).placeholder(R.drawable.ic_group_vilolet).into(holder.groupIconIv);
        }
        catch (Exception e){
            holder.groupIconIv.setImageResource(R.drawable.ic_group_vilolet);
        }
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                        for (DataSnapshot ds:datasnapshot.getChildren()){
                            ...
                            //get init of sender of last message
